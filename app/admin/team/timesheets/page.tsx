...
import { TimesheetsPageWrapper } from '@/components/admin/team-pages/timesheets-page';
        ...
        <div className="max-w-3xl mx-auto">
          <div className="rounded-2xl border border-amber-500/30 bg-gradient-to-br from-amber-500/10 to-orange-500/10 p-8 text-center">
            ...
            <p className="text-slate-300 mb-6">
              Timesheet management is available on the Pro plan. Upgrade to review and approve team timesheets.
            </p>
            <Link
