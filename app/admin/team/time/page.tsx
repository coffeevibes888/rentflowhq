...
import { TimeTrackingPageWrapper } from '@/components/admin/team-pages/time-tracking-page';
        ...
        <div className="max-w-3xl mx-auto">
          <div className="rounded-2xl border border-amber-500/30 bg-gradient-to-br from-amber-500/10 to-orange-500/10 p-8 text-center">
            ...
            <p className="text-slate-300 mb-6">
              Time tracking is available on the Pro plan. Upgrade to track clock in/out and manage attendance.
            </p>
            <Link
