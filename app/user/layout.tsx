  ...
  return (
    <div className='flex min-h-screen flex-col'>
      ...
      <div className='flex flex-1 text-black'>
        {/* Sidebar */}
        <aside className='hidden md:flex flex-col w-64 border-r border-slate-200 border-t-slate-200 bg-transparent backdrop-blur-sm px-4 py-6 gap-6 text-black'>
          <Link href='/' className='flex items-center gap-3 px-2'>
            ...
            <div className='flex flex-col'>
              <span className='text-sm font-semibold text-black'>Resident Portal</span>
              <span className='text-xs text-black'>Profile & Rentals</span>
            </div>
          </Link>
