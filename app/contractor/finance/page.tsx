    ...
    <div className='w-full space-y-5'>
      ...
      <div className='grid gap-4 md:grid-cols-2'>
        ...
        <div className='rounded-xl border border-gray-200 bg-white shadow-sm overflow-hidden'>
          <div className='flex items-center justify-between p-4 border-b border-gray-100'>
            ...
            <Link href='/contractor/invoices' className='text-[11px] text-amber-600 hover:text-amber-700 font-medium flex items-center gap-1'>
          ...
          {recentInvoices.length === 0 ? (
            ...
            <div className='divide-y divide-gray-50'>
              {recentInvoices.map((invoice) => {
                ...
                return (
                  <Link key={invoice.id} href={`/contractor/invoices/${invoice.id}`} className='flex items-center gap-3 px-4 py-3 hover:bg-gray-50/50 transition-colors'>
        ...
        <div className='rounded-xl border border-gray-200 bg-white shadow-sm overflow-hidden'>
          <div className='flex items-center justify-between p-4 border-b border-gray-100'>
            ...
            <Link href='/contractor/expenses' className='text-[11px] text-amber-600 hover:text-amber-700 font-medium flex items-center gap-1'>
              View all <ChevronRight className='h-3 w-3' />
            </Link>
          </div>
          {recentExpenses.length === 0 ? (
            ...
            <div className='divide-y divide-gray-50'>
              {recentExpenses.map((expense) => (
                <Link key={expense.id} href={`/contractor/expenses/${expense.id}`} className='flex items-center gap-3 px-4 py-3 hover:bg-gray-50/50 transition-colors'>
      ...
      <div className='rounded-xl border border-gray-200 bg-white shadow-sm p-4'>
        ...
        <div className='grid grid-cols-2 md:grid-cols-4 gap-3'>
          {[
            { href: '/contractor/invoices/new', icon: FileText, label: 'New Invoice' },
            { href: '/contractor/expenses/new', icon: TrendingDown, label: 'Log Expense' },
            { href: '/contractor/reports', icon: Download, label: 'Reports' },
            { href: '/contractor/payouts', icon: CreditCard, label: 'Payments' },
