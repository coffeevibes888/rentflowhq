    ...
    return (
      <div className='w-full space-y-5'>
        ...
        <div className='rounded-xl border border-gray-200 bg-white p-10 text-center shadow-sm'>
          ...
          <Link href='/contractor/settings/subscription' className='inline-flex items-center gap-2 bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-white px-6 py-2.5 rounded-lg font-semibold transition-all shadow-sm'>
          ...
          <div className='divide-y divide-amber-100'>
            {lowStockAlerts.map((item) => (
              <div key={item.id} className='flex items-center gap-3 px-4 py-3'>
                ...
                {item.vendor && (
                  <Link href={`/contractor/vendors/${item.vendor.id}`}>
