  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-blue-600">Equipment Tracking</h1>
          <p className="text-sm text-gray-600 mt-1">
            Manage tools, equipment, and maintenance schedules
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="rounded-xl border-2 border-gray-200 bg-white p-5 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900">{needsMaintenance}</p>
            ...
            <div className="space-y-3">
              {maintenanceAlerts.map((item) => (
                ...
                >
                  ...
                  <Link
                    href={`/contractor/equipment/${item.id}/maintenance`}
                    className="ml-4"
                  >
                    <Button
                      size="sm"
      ...
      <div className="rounded-xl border-2 border-gray-200 bg-white shadow-sm">
        <div className="p-5 border-b border-gray-200">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <h3 className="text-lg font-semibold text-gray-900">All Equipment</h3>
            <div className="flex gap-2">
