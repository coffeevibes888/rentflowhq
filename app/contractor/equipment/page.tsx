    ...
    return (
      <div className='w-full space-y-5'>
        ...
        <div className='rounded-xl border border-gray-200 bg-white p-10 text-center shadow-sm'>
          ...
          <Link href='/contractor/settings/subscription' className='inline-flex items-center gap-2 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white px-6 py-2.5 rounded-lg font-semibold transition-all shadow-sm'>
    ...
    <div className='w-full space-y-5'>
      ...
      <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3'>
        ...
        <div className='flex gap-2'>
          ...
          <Link href='/contractor/equipment/new'>
          ...
          <div className='divide-y divide-amber-100'>
            {maintenanceAlerts.map((item) => (
              <div key={item.id} className='flex items-center gap-3 px-4 py-3'>
                ...
                <Link href={`/contractor/equipment/${item.id}/maintenance`}>
