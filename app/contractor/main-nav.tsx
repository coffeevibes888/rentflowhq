        ...
        return (
          <Link
            ...
            className={cn(
              ...
              isActive 
                ? 'bg-gradient-to-r from-rose-500/90 to-orange-500/90 text-white shadow-lg shadow-rose-500/20' 
                : 'hover:bg-gradient-to-r hover:from-rose-100 hover:to-orange-100 hover:shadow-md hover:scale-105'
            )}
          >
            <Icon className={cn(
