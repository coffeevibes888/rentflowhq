    ...
    <div className='w-full space-y-5'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
        ...
        <div className='rounded-xl border border-gray-200 bg-white shadow-sm overflow-hidden'>
          <div className='flex items-center justify-between p-4 border-b border-gray-100'>
            ...
            <Link href='/contractor/jobs' className='text-[11px] text-amber-600 hover:text-amber-700 font-medium flex items-center gap-1'>
      ...
      <div className='rounded-xl border border-gray-200 bg-white shadow-sm overflow-hidden'>
        <div className='flex items-center justify-between p-4 border-b border-gray-100'>
          ...
          <Link href='/contractor/leads' className='text-[11px] text-amber-600 hover:text-amber-700 font-medium flex items-center gap-1'>
            View All <ChevronRight className='h-3 w-3' />
          </Link>
        </div>
