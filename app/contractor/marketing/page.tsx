    ...
    <div className='w-full space-y-5'>
      ...
      <div className='grid lg:grid-cols-2 gap-4'>
        ...
        <div className='rounded-xl border border-gray-200 bg-white shadow-sm overflow-hidden'>
          <div className='flex items-center justify-between p-4 border-b border-gray-100'>
            ...
            <Link href='/contractor/marketing/campaigns' className='text-[11px] text-amber-600 hover:text-amber-700 font-medium flex items-center gap-1'>
          ...
          {campaigns.length === 0 ? (
            ...
            <div className='divide-y divide-gray-50'>
              {campaigns.map((campaign) => {
                ...
                return (
                  <Link key={campaign.id} href={`/contractor/marketing/campaigns/${campaign.id}`} className='flex items-center gap-3 px-4 py-3 hover:bg-gray-50/50 transition-colors'>
        ...
        <div className='rounded-xl border border-gray-200 bg-white shadow-sm overflow-hidden'>
          <div className='flex items-center justify-between p-4 border-b border-gray-100'>
            ...
            <Link href='/contractor/marketing/referrals' className='text-[11px] text-amber-600 hover:text-amber-700 font-medium flex items-center gap-1'>
              View All <ChevronRight className='h-3 w-3' />
            </Link>
          </div>
          {referrals.length === 0 ? (
      ...
      <div className='rounded-xl border border-gray-200 bg-white shadow-sm p-4'>
        ...
        <div className='grid sm:grid-cols-3 gap-3'>
          {[
            { href: '/contractor/marketing/campaigns/new', icon: Mail, label: 'Email Campaign', desc: 'Send emails to your customers', color: 'text-violet-500' },
            { href: '/contractor/marketing/campaigns/new?type=sms', icon: MessageSquare, label: 'SMS Campaign', desc: 'Send text messages to customers', color: 'text-emerald-500' },
            { href: '/contractor/marketing/referrals', icon: Users, label: 'Referral Program', desc: 'Track customer referrals', color: 'text-blue-500' },
