...
export default async function ContractorBrandingPage({
  ...
  const handleProfileUpdate = async (formData: FormData) => {
    ...
    if (!result.success) {
      redirect(`/contractor-dashboard/profile/branding?error=${encodeURIComponent(result.message || 'Failed to update')}`);
    }
    redirect('/contractor-dashboard/profile/branding?success=Profile%20updated');
  };
  ...
  const handleProfilePhotoUpload = async (formData: FormData) => {
    ...
    if (!result.success) {
      redirect(`/contractor-dashboard/profile/branding?error=${encodeURIComponent(result.message || 'Failed to upload')}`);
    }
    redirect('/contractor-dashboard/profile/branding?success=Photo%20updated');
  };
  ...
  const handleCoverPhotoUpload = async (formData: FormData) => {
    ...
    redirect('/contractor-dashboard/profile/branding?success=Cover%20photo%20updated');
  };
  ...
  const handlePortfolioUpload = async (formData: FormData) => {
    ...
    redirect('/contractor-dashboard/profile/branding?success=Portfolio%20images%20added');
  };
