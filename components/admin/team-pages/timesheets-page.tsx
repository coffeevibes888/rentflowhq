...
const TimesheetsTab = dynamic(() => import('@/components/admin/team-ops/timesheets-tab'), {
  loading: () => (
      ...
      <div className="relative rounded-xl sm:rounded-2xl border border-white shadow-xl overflow-hidden">
        ...
        <div className="relative p-4 sm:p-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-black">Timesheets</h1>
              <p className="text-xs sm:text-sm text-black/70 mt-0.5">
                Review, approve, and manage team timesheets
              </p>
            </div>
          </div>
        </div>
