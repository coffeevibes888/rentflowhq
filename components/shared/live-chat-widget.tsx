...
export default function LiveChatWidget() {
  ...
  const getAIResponse = (userMessage: string): string => {
    ...
    if (lower.includes('pricing') || lower.includes('cost') || lower.includes('price') || lower.includes('plan') || lower.includes('subscription')) {
      return "We offer flexible pricing based on your portfolio size:\n\n• **Free** - Up to 5 units, basic features\n• **Growth** ($29/mo) - Up to 25 units\n• **Professional** ($79/mo) - Up to 100 units\n• **Enterprise** - Custom pricing for 100+ units\n\nAll plans include rent collection, maintenance tracking, and tenant portal. Would you like to start a free trial?";
    }
