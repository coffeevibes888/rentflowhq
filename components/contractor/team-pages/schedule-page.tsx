...
const ScheduleTab = dynamic(() => import('@/components/contractor/team-ops/schedule-tab'), {
...
export function ContractorSchedulePageWrapper() {
  return (
      ...
      <div className="relative rounded-xl sm:rounded-2xl border border-slate-700 shadow-2xl overflow-hidden">
        ...
        <div className="relative p-4 sm:p-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-white">Team Scheduling</h1>
              <p className="text-xs sm:text-sm text-slate-400 mt-0.5">Create and manage shifts, view your team calendar</p>
            </div>
          </div>
        </div>
      </div>
