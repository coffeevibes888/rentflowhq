    ...
    <section className='w-full py-10 md:py-20 px-4'>
      <div className='max-w-6xl mx-auto space-y-8'>
        ...
        <div className='text-center space-y-3 max-w-3xl mx-auto'>
          ...
          <div className='flex flex-wrap items-center justify-center gap-3 pt-2'>
            {[
              ...
              <span
                key={label}
                className='inline-flex items-center gap-1.5 text-xs font-semibold text-orange-700 bg-blue-400 px-3 py-1.5 rounded-full border border-black'
              >
        ...
        <div className='grid gap-4 md:gap-6 md:grid-cols-2'>
          <div className='md:col-span-2 group relative rounded-2xl md:rounded-3xl overflow-hidden transition-all duration-500 hover:scale-[1.01] bg-linear-to-r from-teal-400 via-teal-200 to-emerald-600 border border-black shadow-2xl'>
            <div className='absolute top-4 right-4 md:top-6 md:right-6'>
              <span className='inline-flex items-center gap-1 bg-blue-200 text-white text-[10px] md:text-xs font-bold px-3 py-1.5 rounded-full border border-black'>
                <span className='relative flex h-2 w-2'>
                  <span className='animate-ping absolute inline-flex h-full w-full rounded-full bg-gradient-to-r from-teal-400 to-yellow-200 opacity-75'></span>
                  <span className='relative inline-flex rounded-full h-2 w-2 bg-gradient-to-r from-teal-400 to-yellow-200'></span>
                </span>
                AUTOMATED
              </span>
            </div>
            <div className='relative p-6 md:p-8 space-y-4 md:space-y-6'>
              <div className='space-y-2'>
                ...
                <p className='text-black text-sm md:text-base'>Every job follows this flow — automatically</p>
              </div>
              ...
              <div className='lg:hidden space-y-2'>
                {[
                  [
                    { label: 'Lead Comes In', sub: 'Marketplace or Direct', border: 'border-white', color: 'text-white' },
                    { label: 'Send Quote', sub: 'Built-in Quote Builder', border: 'border-black', color: 'text-black' },
                  ],
                  [
                    { label: 'Customer Accepts', sub: 'One Click Approval', border: 'border-white', color: 'text-white' },
                    { label: 'Contract Auto-Sent', sub: 'E-Signature Ready', border: 'border-black', color: 'text-black' },
                  ],
                  [
                    { label: 'Customer Signs', sub: 'Legally Binding', border: 'border-white', color: 'text-white' },
                    { label: 'Job Created', sub: 'Auto-Scheduled', border: 'border-black', color: 'text-black' },
                  ],
                  [
                    { label: 'Upload Photos', sub: 'Before / During / After', border: 'border-white', color: 'text-white' },
                    { label: 'Track Progress', sub: 'Real-Time Updates', border: 'border-black', color: 'text-black' },
                  ],
                  [
                    { label: 'Job Complete', sub: 'Customer Notified', border: 'border-orange-300', color: 'text-white' },
                    { label: 'Invoice Sent', sub: 'Auto-Generated', border: 'border-amber-400', color: 'text-black' },
                  ],
                  [
                    { label: 'Get Paid', sub: 'Direct to Bank', border: 'border-orange-500', color: 'text-white' },
                    { label: 'Get Reviews', sub: 'Auto-Requested', border: 'border-amber-500', color: 'text-black' },
                  ],
                ].map((row, i) => (
                  <div key={i} className='flex items-center gap-1 sm:gap-2'>
                    <div className={`flex-1 bg-blue-400 backdrop-blur-sm rounded-lg px-2 py-2 border-2 ${row[0].border} text-center shadow-sm`}>
                    ...
                    <svg className='h-4 w-4 text-black shrink-0' fill='currentColor' viewBox='0 0 20 20'>
                      <path fillRule='evenodd' d='M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z' clipRule='evenodd' />
                    </svg>
                    <div className={`flex-1 bg-blue-400 backdrop-blur-sm rounded-lg px-2 py-2 border-2 ${row[1].border} text-center shadow-sm`}>
